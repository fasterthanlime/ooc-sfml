...
typedef struct ___lang_Format_closure226_ctx __lang_Format_closure226_ctx;
...
struct ___lang_Format_closure226_ctxClass;
typedef struct ___lang_Format_closure226_ctxClass __lang_Format_closure226_ctxClass;
...
__lang_Format_closure226_ctxClass *__lang_Format_closure226_ctx_class();
void __lang_Format_closure226_ctx___load__();
...
void lang_Format__argNext(uint8_t* __genericReturn22, lang_VarArgs__VarArgsIterator* va, lang_types__Class* T);
...
void lang_Format__format_main(uint8_t* __genericReturn26, lang_types__Class* T, uint8_t* fmt, lang_VarArgs__VarArgs args);
void lang_Format____lang_Format_closure226(lang_types__Pointer end, lang_Character__Char* start, lang_Character__Char** p);
void lang_Format____lang_Format_closure226_thunk(__lang_Format_closure226_ctx* __context__);

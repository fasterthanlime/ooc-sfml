...
struct ___lang_Format_closure226_ctx {
...
#ifdef OOC_FROM_C
#define argNext(__genericReturn22, T, va, T) lang_Format__argNext((__genericReturn22), (T), (va), (void*) (T))
...
#define format_main(__genericReturn26, T, fmt, ...) lang_Format__format_main((__genericReturn26), (T), (fmt), __VA_ARGS__)
#define __lang_Format_closure226(end, start, p) lang_Format____lang_Format_closure226((void*) (end), (start), (p))
#define __lang_Format_closure226_thunk(__context__) lang_Format____lang_Format_closure226_thunk((__context__))

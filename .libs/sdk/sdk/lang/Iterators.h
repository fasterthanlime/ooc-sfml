...
#define Iterable_reduce(_this_, __genericReturn40, f) lang_Iterators__Iterable_reduce((void*) (_this_), (__genericReturn40), (f))
...
#define Iterator_next(_this_, __genericReturn45) lang_Iterators__Iterator_next((void*) (_this_), (__genericReturn45))
...
#define BackIterator_prev(_this_, __genericReturn46) lang_Iterators__BackIterator_prev((void*) (_this_), (__genericReturn46))
...
#define ReverseIterator_next(_this_, __genericReturn47) lang_Iterators__ReverseIterator_next((void*) (_this_), (__genericReturn47))
#define ReverseIterator_hasPrev__quest(_this_) lang_Iterators__ReverseIterator_hasPrev__quest((void*) (_this_))
#define ReverseIterator_prev(_this_, __genericReturn48) lang_Iterators__ReverseIterator_prev((void*) (_this_), (__genericReturn48))

...
void structs_ArrayList__ArrayList_get(structs_ArrayList__ArrayList* this, uint8_t* __genericReturn60, lang_Numbers__SSizeT index);
void structs_ArrayList__ArrayList_get_impl(structs_ArrayList__ArrayList* this, uint8_t* __genericReturn60, lang_Numbers__SSizeT index);
...
void structs_ArrayList__ArrayList_removeAt(structs_ArrayList__ArrayList* this, uint8_t* __genericReturn61, lang_Numbers__SSizeT index);
void structs_ArrayList__ArrayList_removeAt_impl(structs_ArrayList__ArrayList* this, uint8_t* __genericReturn61, lang_Numbers__SSizeT index);
...
void structs_ArrayList__ArrayList_set(structs_ArrayList__ArrayList* this, uint8_t* __genericReturn62, lang_Numbers__Int index, uint8_t* element);
void structs_ArrayList__ArrayList_set_impl(structs_ArrayList__ArrayList* this, uint8_t* __genericReturn62, lang_Numbers__Int index, uint8_t* element);
...
void structs_ArrayList__ArrayListIterator_next(structs_ArrayList__ArrayListIterator* this, uint8_t* __genericReturn63);
void structs_ArrayList__ArrayListIterator_next_impl(structs_ArrayList__ArrayListIterator* this, uint8_t* __genericReturn63);
...
void structs_ArrayList__ArrayListIterator_prev(structs_ArrayList__ArrayListIterator* this, uint8_t* __genericReturn64);
void structs_ArrayList__ArrayListIterator_prev_impl(structs_ArrayList__ArrayListIterator* this, uint8_t* __genericReturn64);
...
void structs_ArrayList____OP_IDX_ArrayList_Int__T(uint8_t* __genericReturn59, lang_types__Class* T, structs_ArrayList__ArrayList* list, lang_Numbers__Int i);

...
#define ArrayList_get(_this_, __genericReturn60, index) structs_ArrayList__ArrayList_get((void*) (_this_), (__genericReturn60), (index))
...
#define ArrayList_removeAt(_this_, __genericReturn61, index) structs_ArrayList__ArrayList_removeAt((void*) (_this_), (__genericReturn61), (index))
...
#define ArrayList_set(_this_, __genericReturn62, index, element) structs_ArrayList__ArrayList_set((void*) (_this_), (__genericReturn62), (index), (element))
...
#define ArrayListIterator_next(_this_, __genericReturn63) structs_ArrayList__ArrayListIterator_next((void*) (_this_), (__genericReturn63))
#define ArrayListIterator_hasPrev__quest(_this_) structs_ArrayList__ArrayListIterator_hasPrev__quest((void*) (_this_))
#define ArrayListIterator_prev(_this_, __genericReturn64) structs_ArrayList__ArrayListIterator_prev((void*) (_this_), (__genericReturn64))

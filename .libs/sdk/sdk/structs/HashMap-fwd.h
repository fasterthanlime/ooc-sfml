...
void structs_HashMap__HashMap_get(structs_HashMap__HashMap* this, uint8_t* __genericReturn78, uint8_t* key);
void structs_HashMap__HashMap_get_impl(structs_HashMap__HashMap* this, uint8_t* __genericReturn78, uint8_t* key);
...
void structs_HashMap__HashMapValueIterator_next(structs_HashMap__HashMapValueIterator* this, uint8_t* __genericReturn80);
void structs_HashMap__HashMapValueIterator_next_impl(structs_HashMap__HashMapValueIterator* this, uint8_t* __genericReturn80);
...
void structs_HashMap__HashMapValueIterator_prev(structs_HashMap__HashMapValueIterator* this, uint8_t* __genericReturn81);
void structs_HashMap__HashMapValueIterator_prev_impl(structs_HashMap__HashMapValueIterator* this, uint8_t* __genericReturn81);
...
void structs_HashMap____OP_IDX_HashMap_K__V(uint8_t* __genericReturn77, lang_types__Class* K, lang_types__Class* V, structs_HashMap__HashMap* map, uint8_t* key);

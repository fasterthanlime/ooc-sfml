...
#define LinkedList_get(_this_, __genericReturn100, index) structs_LinkedList__LinkedList_get((void*) (_this_), (__genericReturn100), (index))
...
#define LinkedList_first(_this_, __genericReturn103) structs_LinkedList__LinkedList_first((void*) (_this_), (__genericReturn103))
#define LinkedList_last(_this_, __genericReturn104) structs_LinkedList__LinkedList_last((void*) (_this_), (__genericReturn104))
#define LinkedList_removeAt(_this_, __genericReturn105, index) structs_LinkedList__LinkedList_removeAt((void*) (_this_), (__genericReturn105), (index))
...
#define LinkedList_set(_this_, __genericReturn108, index, data) structs_LinkedList__LinkedList_set((void*) (_this_), (__genericReturn108), (index), (data))
...
#define LinkedListIterator_next(_this_, __genericReturn117) structs_LinkedList__LinkedListIterator_next((void*) (_this_), (__genericReturn117))
#define LinkedListIterator_hasPrev__quest(_this_) structs_LinkedList__LinkedListIterator_hasPrev__quest((void*) (_this_))
#define LinkedListIterator_prev(_this_, __genericReturn118) structs_LinkedList__LinkedListIterator_prev((void*) (_this_), (__genericReturn118))

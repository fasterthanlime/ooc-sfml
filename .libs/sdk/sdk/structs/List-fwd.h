...
typedef struct ___structs_List_closure220_ctx __structs_List_closure220_ctx;
typedef struct ___structs_List_closure223_ctx __structs_List_closure223_ctx;
struct _structs_List__ListClass;
typedef struct _structs_List__ListClass structs_List__ListClass;
struct ___structs_List_closure220_ctxClass;
typedef struct ___structs_List_closure220_ctxClass __structs_List_closure220_ctxClass;
struct ___structs_List_closure223_ctxClass;
typedef struct ___structs_List_closure223_ctxClass __structs_List_closure223_ctxClass;
...
void structs_List__List_get(structs_List__List* this, uint8_t* __genericReturn66, lang_Numbers__SSizeT index);
...
void structs_List__List_removeAt(structs_List__List* this, uint8_t* __genericReturn67, lang_Numbers__SSizeT index);
lang_types__Bool structs_List__List_remove(structs_List__List* this, uint8_t* element);
void structs_List__List_set(structs_List__List* this, uint8_t* __genericReturn68, lang_Numbers__SSizeT index, uint8_t* element);
...
void structs_List__List_first(structs_List__List* this, uint8_t* __genericReturn69);
void structs_List__List_first_impl(structs_List__List* this, uint8_t* __genericReturn69);
void structs_List__List_last(structs_List__List* this, uint8_t* __genericReturn70);
void structs_List__List_last_impl(structs_List__List* this, uint8_t* __genericReturn70);
...
__structs_List_closure220_ctxClass *__structs_List_closure220_ctx_class();
void __structs_List_closure220_ctx___load__();
__structs_List_closure223_ctxClass *__structs_List_closure223_ctx_class();
void __structs_List_closure223_ctx___load__();
void structs_List_load();
void structs_List____structs_List_closure220(lang_types__Closure f, structs_List__List* copy, lang_types__Class* K, uint8_t* x);
void structs_List____structs_List_closure220_thunk(uint8_t* x, __structs_List_closure220_ctx* __context__);
void structs_List____structs_List_closure223(lang_types__Closure f, structs_List__List* copy, uint8_t* x);
void structs_List____structs_List_closure223_thunk(uint8_t* x, __structs_List_closure223_ctx* __context__);
void structs_List____OP_IDX_List_SSizeT__T(uint8_t* __genericReturn65, lang_types__Class* T, structs_List__List* list, lang_Numbers__SSizeT i);

...
struct ___structs_List_closure220_ctx {
    lang_types__Closure f;
    structs_List__List* copy;
    lang_types__Class* K;
};

struct ___structs_List_closure223_ctx {
    lang_types__Closure f;
    structs_List__List* copy;
};
...
#ifdef OOC_FROM_C
#define __structs_List_closure220(f, copy, K, x) structs_List____structs_List_closure220((f), (void*) (copy), (void*) (K), (x))
#define __structs_List_closure220_thunk(x, __context__) structs_List____structs_List_closure220_thunk((x), (__context__))
#define __structs_List_closure223(f, copy, x) structs_List____structs_List_closure223((f), (void*) (copy), (x))
#define __structs_List_closure223_thunk(x, __context__) structs_List____structs_List_closure223_thunk((x), (__context__))
...
#define List_get(_this_, __genericReturn66, index) structs_List__List_get((void*) (_this_), (__genericReturn66), (index))
...
#define List_removeAt(_this_, __genericReturn67, index) structs_List__List_removeAt((void*) (_this_), (__genericReturn67), (index))
#define List_remove(_this_, element) structs_List__List_remove((void*) (_this_), (element))
#define List_set(_this_, __genericReturn68, index, element) structs_List__List_set((void*) (_this_), (__genericReturn68), (index), (element))
...
#define List_first(_this_, __genericReturn69) structs_List__List_first((void*) (_this_), (__genericReturn69))
#define List_last(_this_, __genericReturn70) structs_List__List_last((void*) (_this_), (__genericReturn70))

...
void structs_Stack__Stack_pop(structs_Stack__Stack* this, uint8_t* __genericReturn90);
void structs_Stack__Stack_pop_impl(structs_Stack__Stack* this, uint8_t* __genericReturn90);
void structs_Stack__Stack_peek(structs_Stack__Stack* this, uint8_t* __genericReturn92);
void structs_Stack__Stack_peek_impl(structs_Stack__Stack* this, uint8_t* __genericReturn92);
void structs_Stack__Stack_peek_index(structs_Stack__Stack* this, uint8_t* __genericReturn94, lang_Numbers__SSizeT index);
void structs_Stack__Stack_peek_index_impl(structs_Stack__Stack* this, uint8_t* __genericReturn94, lang_Numbers__SSizeT index);

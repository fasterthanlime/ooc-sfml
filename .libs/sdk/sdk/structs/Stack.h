...
#define Stack_pop(_this_, __genericReturn90) structs_Stack__Stack_pop((void*) (_this_), (__genericReturn90))
#define Stack_peek(_this_, __genericReturn92) structs_Stack__Stack_peek((void*) (_this_), (__genericReturn92))
#define Stack_peek_index(_this_, __genericReturn94, index) structs_Stack__Stack_peek_index((void*) (_this_), (__genericReturn94), (index))
